...
const denormalizedEmpres = denormalize(normalizedEmpresa.result, organigrama, normalizedEmpresa.entities);
print(denormalizedEmpres)
...
console.log('Longitud del objeto desnormalizado: ', JSON.stringify(denormalizedEmpres).length);
